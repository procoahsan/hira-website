import { Q as reactExports, I as jsxRuntimeExports, a3 as useRouter } from "./server-KbOrpO-8.mjs";
import { u as useTheme, L as Link } from "./router-DWjYwRDo.mjs";
...
const darkLogo = "/assets/dark-logo-BLREXsAk.png";
const lightLogo = "/assets/light-logo-DJmlBq-I.png";
const nav = [
  { to: "/", label: "Home" },
      ...
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mx-auto max-w-7xl px-6 flex items-center justify-between transition-all duration-300 ${scrolled ? "h-16" : "h-20"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-0.5 group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border/60 mt-24 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-16 grid md:grid-cols-4 gap-10 relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-md leading-relaxed", children: "Helping Muslim women grow — from the inside out. Coaching, Seerah, and structured learning available in English and Urdu, worldwide." }),
