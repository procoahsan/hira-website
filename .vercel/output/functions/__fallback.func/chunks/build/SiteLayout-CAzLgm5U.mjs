import { P as reactExports, H as jsxRuntimeExports, a2 as useRouter } from "./server-CeGdAUma.mjs";
import { u as useTheme, L as Link } from "./router-DBvwF3Ob.mjs";
...
function SiteLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `sticky top-0 z-50 transition-all duration-300 ${scrolled ? "backdrop-blur-2xl bg-background/85 border-b border-border/60 shadow-soft" : "backdrop-blur-xl bg-background/60"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mx-auto max-w-7xl px-6 flex items-center justify-between transition-all duration-300 ${scrolled ? "h-16" : "h-20"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid place-items-center w-11 h-11 rounded-full bg-emerald-gradient text-primary-foreground font-display text-xl shadow-soft group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300", children: "﷽" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1", children: nav.map((n) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  to: n.to,
                  className: `relative px-3 py-2 text-sm transition-all duration-200 rounded-lg ${active ? "text-primary bg-primary/5" : "text-foreground/70 hover:text-foreground hover:bg-muted/50"}`,
                  children: [
                    n.label,
                    active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 right-3 -bottom-0.5 h-0.5 bg-gold rounded-full" })
                  ]
                },
                n.to
              );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `lg:hidden overflow-hidden transition-all duration-300 ease-out ${open ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/60 bg-background/95 backdrop-blur-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 flex flex-col gap-1", children: [
                nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: n.to,
                    onClick: () => setOpen(false),
                    className: `py-2.5 px-3 text-sm rounded-xl transition-all ${path === n.to ? "text-primary bg-primary/5 font-medium" : "text-foreground/80 hover:text-primary hover:bg-muted/50"}`,
                    children: n.label
                  },
                  n.to
                )),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border/60 mt-24 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-primary/5 rounded-full blur-[200px]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-16 grid md:grid-cols-4 gap-10 relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-3xl", children: "Hira Saqib" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground max-w-md leading-relaxed", children: "Helping Muslim women grow — from the inside out. Coaching, Seerah, and structured learning available in English and Urdu, worldwide." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: nav.slice(1, 5).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: n.to, className: "hover:text-primary transition-colors", children: n.label }) }, n.to)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/newsletter", className: "hover:text-primary transition-colors", children: "Newsletter" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/bookings", className: "hover:text-primary transition-colors", children: "Discovery call" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:info@hirasaqib.com", className: "hover:text-primary transition-colors", children: "info@hirasaqib.com" }) })
          ] })
        ] })
      ] }),
