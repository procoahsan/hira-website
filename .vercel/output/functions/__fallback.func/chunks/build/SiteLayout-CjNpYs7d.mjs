import { Q as reactExports, I as jsxRuntimeExports, a3 as useRouter } from "./server-CUff86dv.mjs";
import { u as useTheme, L as Link } from "./router-BTdp4RvQ.mjs";
...
const socials = [
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-5 h-5", fill: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
        fillRule: "evenodd",
      ...
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `mx-auto max-w-7xl px-6 flex items-center justify-between transition-all duration-300 ${scrolled ? "h-16" : "h-20"}`,
              children: [
