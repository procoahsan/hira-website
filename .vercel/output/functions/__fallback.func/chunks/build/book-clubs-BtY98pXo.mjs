...
import { S as SiteLayout } from "./SiteLayout-CAzLgm5U.mjs";
...
function BookClubs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 grid md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-8", children: clubs.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "bg-card border border-border rounded-[2rem] overflow-hidden flex flex-col hover:shadow-soft transition group min-h-[620px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: c.image, alt: c.name, loading: "lazy", className: "w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-500" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-widest text-gold mb-1", children: c.age }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-3xl mb-3", children: c.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed flex-1 text-[16px]", children: c.body }),
        c.extra && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-4 rounded-2xl bg-secondary/60 border border-border/60", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: c.link, target: c.link.startsWith("http") ? "_blank" : void 0, rel: "noreferrer", className: "mt-5 inline-flex items-center gap-2 text-sm text-primary font-medium", children: [
          c.cta,
          " →"
        ] })
      ] })
