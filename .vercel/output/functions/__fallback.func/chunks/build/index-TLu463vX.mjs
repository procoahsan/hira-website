...
import { S as SiteLayout, A as ArrowRight, c as createLucideIcon } from "./SiteLayout-CAzLgm5U.mjs";
import { S as Sparkles, U as Users } from "./users-Cungwd05.mjs";
import { H as Heart } from "./heart-DvV8LoPz.mjs";
import { B as BookOpen } from "./book-open-DK6dgaZ-.mjs";
import { m as motion } from "./proxy-CcXFhovX.mjs";
...
function HeroCourseCarousel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-xl overflow-hidden rounded-3xl border border-border/70 bg-card/70 p-3 shadow-soft backdrop-blur reveal", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "flex", animate: {
      x: `-${activeIndex * 100}%`
    }, transition: {
      type: "spring",
      stiffness: 130,
      ...
      body,
      to
    }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to, className: "min-w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-[142px] gap-4 rounded-2xl bg-background/80 p-5 transition hover:bg-muted/70", children: [
...
function FeedbackCarousel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-[0.9fr_1.1fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-muted-foreground leading-relaxed", children: "Seerah participants shared these reflections after studying, discussing, and applying the lessons." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", "aria-label": "Previous feedback", onClick: () => move(-1), className: "grid h-11 w-11 place-items-center rounded-full border border-border bg-card text-primary transition hover:bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", "aria-label": "Next feedback", onClick: () => move(1), className: "grid h-11 w-11 place-items-center rounded-full border border-border bg-card text-primary transition hover:bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-5 w-5" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-[430px] md:h-[480px] reveal", children: feedbacks.map((feedback, index) => {
      const offset = (index - activeIndex + feedbacks.length) % feedbacks.length;
      const visible = offset < 4;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.article, { className: "absolute inset-x-0 top-0 mx-auto max-w-xl rounded-[2rem] border border-border bg-card p-7 shadow-elegant", initial: false, animate: {
        opacity: visible ? 1 : 0,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "h-9 w-9 text-gold/70" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-5 text-lg leading-relaxed text-foreground/85 line-clamp-7", children: [
          '"',
          feedback.quote,
          '"'
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-11 w-11 place-items-center rounded-full bg-emerald-gradient text-sm font-bold text-primary-foreground", children: feedback.name.charAt(0) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium", children: feedback.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: feedback.location })
          ] })
        ] })
      ] }, `${feedback.name}-${index}`);
    }) })
