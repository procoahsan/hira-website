...
var Accordion$1 = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Collection.Provider, {
    ...
    children:
      type === "multiple"
        ? /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionImplMultiple, {
            ...multipleProps,
            ref: forwardedRef,
          })
        : /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionImplSingle, {
            ...singleProps,
            ref: forwardedRef,
          }),
  });
...
var AccordionImplSingle = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionValueProvider, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionCollapsibleProvider, {
      scope: props.__scopeAccordion,
      collapsible,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionImpl, {
        ...accordionSingleProps,
        ref: forwardedRef,
      }),
    }),
...
var AccordionHeader = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive.h3, {
    "data-orientation": accordionContext.orientation,
...
const AccordionItem = reactExports.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsxRuntimeExports.jsx(Item, {
    ref,
...
const AccordionTrigger = reactExports.forwardRef(({ className, children, ...props }, ref) =>
...
const AccordionContent = reactExports.forwardRef(({ className, children, ...props }, ref) =>
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              ...
              children: framework.map(({ icon: Icon, title, body }) =>
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
              ...
              children: faqs.map((faq, index) =>
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  AccordionItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, {
                        className:
...
export { TheRiseProgram as component };
