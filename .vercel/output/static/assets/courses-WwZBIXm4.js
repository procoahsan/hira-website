import { r as m, j as e, L as h } from "./index-CLEWXjBW.js";
import { S as d, A as c } from "./SiteLayout-ClMWzJak.js";
import { P as u } from "./PageHeader-cvIMhO7K.js";
import { h as g } from "./home-schooling-DIiish7e.js";
import { m as s } from "./proxy-DtwS0EBc.js";
import { C as p } from "./check-q1THb-vR.js";
const x = "/assets/rise-program-CBbZ-sHJ.jpeg",
  l = "/assets/seerah-64ESgd6-.jpeg",
  f = [
    {
  ...
  return e.jsxs(d, {
    children: [
      e.jsx(u, {
        ...
        intro:
          "Four programmes, each a different doorway into the same practice: substance, rooted in faith.",
      }),
      e.jsx("section", {
        className: "py-12",
        children: e.jsx("div", {
          className:
            "mx-auto max-w-7xl px-6 grid md:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-8 items-start",
          children: f.map((t, a) => {
            const o = n === a;
            return e.jsxs(
              s.article,
              {
                ...
                className:
                  "bg-card border border-border rounded-3xl overflow-hidden flex flex-col hover:shadow-soft transition-shadow min-h-[520px]",
                style: { zIndex: o ? 10 : 1 },
                children: [
                  t.image
                    ? e.jsx(s.div, {
                        ...
                        children: e.jsx(s.img, {
                          ...
                          loading: "lazy",
                          className: "w-full",
                          style: { objectFit: o ? "contain" : "cover", height: o ? "auto" : 230 },
                        }),
                      })
                    : e.jsxs("div", {
                        className:
                          "bg-emerald-gradient text-primary-foreground p-5 h-56 flex flex-col justify-end",
                        children: [
                          e.jsx("div", {
                  ...
                  e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsx("h3", { className: "font-display text-xl mb-2", children: t.title }),
                      e.jsx("p", {
                      ...
                      e.jsx("ul", {
                        ...
                        children: t.bullets.map((i) =>
                          e.jsxs(
                            "li",
                            {
                              className: "flex items-start gap-2 text-sm text-foreground/85",
                              children: [
                                e.jsx(p, { className: "w-4 h-4 text-gold shrink-0 mt-0.5" }),
                                " ",
                                i,
                              ],
                            },
                      ...
                      e.jsxs(h, {
                        to: t.to,
                        className:
                          "mt-4 inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm hover:-translate-y-0.5 transition self-start",
                        children: [t.cta, " ", e.jsx(c, { className: "w-4 h-4" })],
                      }),
                    ],
                  }),
                ],
