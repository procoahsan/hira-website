  ...
  return (
    <SiteLayout>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-96 h-96 bg-gold/15 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "2s" }} />
        ...
        <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-10 lg:gap-16 relative z-10">
          ...
          <div className="lg:col-span-4 space-y-8 animate-in-up" style={{ animationDelay: "0.1s" }}>
            <div className="glass-card rounded-3xl p-8 shadow-elegant border border-border/50 bg-card/60 backdrop-blur-2xl shimmer-border">
              <h3 className="font-display text-2xl mb-6 text-gradient font-semibold">What to expect</h3>
              
              <div className="space-y-6">
                {[
                  { icon: Clock, t: "30 minutes", b: "Long enough to listen, short enough to honour your day." },
                  { icon: Video, t: "Google Meet / Zoom", b: "Your call link will be sent after booking." },
                  ...
                  { icon: ShieldCheck, t: "Confidential", b: "Everything shared stays between us." },
                ].map(({ icon: Icon, t, b }) => (
