        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="bg-card border border-border rounded-3xl p-10 md:p-14 shadow-soft">
            <p className="text-lg leading-relaxed text-foreground/85">
              ...
              while your own dreams and well-being get left on the back burner? Do you feel pulled
              in a dozen directions, managing a household, a career, and relationships, all while
              trying to process the weight of past experiences?
            </p>
            <p className="mt-6 text-lg leading-relaxed text-foreground/85">
              You are capable, you are strong, but even the strongest among us need a dedicated
              space to heal, grow, and design a life that truly fulfills them.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-6">
              <div className="text-gold font-display text-3xl">
                US$ 74.99<span className="text-lg text-muted-foreground">/month</span>
              </div>
              <a
